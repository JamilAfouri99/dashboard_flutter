...
class PatchUserDto {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PatchUserDto &&
     other.email == email &&
  ...
  @override
  String toString() => 'PatchUserDto[email=$email, firstName=$firstName, lastName=$lastName, avatar=$avatar, role=$role, status=$status, groupId=$groupId]';
  ...
  static List<PatchUserDto>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<PatchUserDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PatchUserDto>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PatchUserDto.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
...
class PatchUserDtoRoleEnum {
  ...
  static PatchUserDtoRoleEnum? fromJson(dynamic value) => PatchUserDtoRoleEnumTypeTransformer().decode(value);

  static List<PatchUserDtoRoleEnum>? listFromJson(dynamic json, {bool growable = false,}) {
...
class PatchUserDtoRoleEnumTypeTransformer {
  factory PatchUserDtoRoleEnumTypeTransformer() => _instance ??= const PatchUserDtoRoleEnumTypeTransformer._();
  ...
  PatchUserDtoRoleEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'USER': return PatchUserDtoRoleEnum.USER;
        case r'OWNER': return PatchUserDtoRoleEnum.OWNER;
        case r'ADMIN': return PatchUserDtoRoleEnum.ADMIN;
        case r'SUPERADMIN': return PatchUserDtoRoleEnum.SUPERADMIN;
        default:
          if (!allowNull) {
...
class PatchUserDtoStatusEnum {
  ...
  static PatchUserDtoStatusEnum? fromJson(dynamic value) => PatchUserDtoStatusEnumTypeTransformer().decode(value);

  static List<PatchUserDtoStatusEnum>? listFromJson(dynamic json, {bool growable = false,}) {
...
class PatchUserDtoStatusEnumTypeTransformer {
  factory PatchUserDtoStatusEnumTypeTransformer() => _instance ??= const PatchUserDtoStatusEnumTypeTransformer._();
  ...
  PatchUserDtoStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'ACTIVE': return PatchUserDtoStatusEnum.ACTIVE;
        case r'INACTIVE': return PatchUserDtoStatusEnum.INACTIVE;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
